...
def main(cfg: DictConfig):
    ...
    if cfg.nproc_per_node == -1:
        import torch
        cfg.nproc_per_node = torch.cuda.device_count()
        print(f"Number of available GPUs: {cfg.nproc_per_node}")
    ...
    args.extend([
        ...
        "--video_max_frame_pixels", str(cfg.video_max_frame_pixels),
        "--video_min_frame_pixels", str(cfg.video_min_frame_pixels),
